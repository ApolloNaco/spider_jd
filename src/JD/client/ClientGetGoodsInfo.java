...
public class ClientGetGoodsInfo
{
	...
	public  void start()
	{
		 ...
		 long t1=System.currentTimeMillis();
			...
			HttpGet get4 =new HttpGet("https://p.3.cn/prices/mgets?skuIds="+url+"&pdbp=0&pdtk=&pdpin=&pduid=131242956&source=list_pc_front&_=1494422447061");
...
//				//System.out.println("haha: id:"+obj.getString("Goods_ID")+"  p:"+obj.getString("Goods_price"));
...
//			
			...
			System.out.println("爬到100个商品信息,共花费"+(t2-t1)+"ms");
			...
			{
				new Thread(new SendGoodInfoToServer(jsonArray.getJSONObject(i).toString(), ip, port2)).start();
